...
class StockMovementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stock_movement" do
    assert_difference('StockMovement.count') do
      post stock_movements_url, params: { stock_movement: { commodity_id: @stock_movement.commodity_id, description: @stock_movement.description, destination_hub_id: @stock_movement.destination_hub_id, destination_store_id: @stock_movement.destination_store_id, destination_warehouse_id: @stock_movement.destination_warehouse_id, project_id: @stock_movement.project_id, quantity: @stock_movement.quantity, quantity: @stock_movement.quantity, source_hub_id: @stock_movement.source_hub_id, source_store_id: @stock_movement.source_store_id, source_warehouse_id: @stock_movement.source_warehouse_id } }
    end
  ...
  test "should update stock_movement" do
    patch stock_movement_url(@stock_movement), params: { stock_movement: { commodity_id: @stock_movement.commodity_id, description: @stock_movement.description, destination_hub_id: @stock_movement.destination_hub_id, destination_store_id: @stock_movement.destination_store_id, destination_warehouse_id: @stock_movement.destination_warehouse_id, project_id: @stock_movement.project_id, quantity: @stock_movement.quantity, quantity: @stock_movement.quantity, source_hub_id: @stock_movement.source_hub_id, source_store_id: @stock_movement.source_store_id, source_warehouse_id: @stock_movement.source_warehouse_id } }
